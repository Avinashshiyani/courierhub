...
<div class="lg:flex lg:items-start bg-[#191c24]">
    ...
    <div class="w-4/5 w-full grid items-center  pt-[75px]">
        ...
        <div class="bg-[#000000] grid items-center px-6 py-3 ">
            <p class="text-white font-semibold">Cash Booking</p>
            <form action="../controller/insert_cashbooking.php" method="post">
                    ...
                    <div class="grid items-center my-6 px-4 py-6 bg-[#191C24] xl:my-0">        
                        <div class="grid items-center space-y-3">
                            ...
                            <div class="grid items-center text-white space-y-2.5">
                                ...
                                <input type="text" name="from_name" required placeholder="From Name"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Mobile No =</label>
                                <input type="number" name="from_phno" required placeholder="From Phno"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                        </div>
                    </div>
                    <div class="grid items-center  px-6 py-4 bg-[#191C24]">
                        <div class="grid items-center space-y-3">
                            ...
                            <div class="grid items-center text-white space-y-2.5">
                                ...
                                <input type="number" name="document_no" required placeholder="Document No"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Name =</label>
                                <input type="text" name="to_name" required placeholder="To Name"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <?php
                            ...
                            <div class="grid items-center text-white space-y-2.5">
                                ...
                                <input type="number" name="to_weight" required placeholder="Weight in kg"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Address =</label>
                                <input type="text" name="to_address" required placeholder="To Address"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Total Amount =</label>
                                <input type="text" name="to_total_amt" required value="40" placeholder="From Name"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="flex items-center text-white space-x-2.5 font-semibold">
                                <div class="">
                                    <a href="../components/printinfo/cashbooking_print.php">
                                        <button
                                            class="bg-[#0090e7] h-[30px] w-[75px] text-[15px] rounded-sm">Submit</button>
                                    </a>
                                </div>
                                <div class="">
                                    <a href="">
