    ...
    <div class="w-4/5 w-full grid items-center  pt-[75px]">
        ...
        <div class="bg-[#000000]  grid items-center px-6 py-3 ">
            ...
            <div class="grid items-center h-screen xl:grid-cols-2 xl:py-3 xl:gap-6 xl:items-start">
                <form action="../controller/insert_admin_employee.php" method="post">
                    <div class="grid items-center my-6 px-4 py-6 bg-[#191C24] xl:my-0">
                        <div class="grid items-center space-y-3">
                            ...
                            <div class="grid items-center text-white space-y-2.5">
                                ...
                                <input type="text" name="employee_name" required placeholder=" Name" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Role :-</label>
                                <input type="text" name="employee_role" required placeholder="Role Of Employee" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Salary :-</label>
                                <input type="number" name="employee_salary" required placeholder="From Name" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                ...
                <?php include '../controller/select_admin_employee.php'; ?>
                        ...
                        <?php foreach ($select as $row) : ?>
                            <div class="grid items-center space-y-2 py-2.5">
                                <div class="flex  items-center bg-[#2A3038] justify-between ">
                                    ...
                                    <div class="text-white w-full text-center ">
                                        <span><?= $row['ae_name'] ?></span>
                                    </div>
                                    <div class="text-white w-full  text-center ">
                                        <span><?= $row['ae_role'] ?></span>
                                    </div>
                                    <div class="text-white w-full  text-center ">
                                        <span><?= $row['ae_salary'] ?></span>
                                    </div>
                                    <div class="flex items-center text-white w-full  text-center ">

                                        <a href="../controller/delete_branch_employee.php?delete=<?= $row['ae_id'] ?>" class="h-[40px] text-red-500 px-2 flex items-center">
                                            <span>Remove</span>
                                        </a>
                                    </div>
                                </div>
