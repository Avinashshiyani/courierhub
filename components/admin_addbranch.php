...
<div class=" grid items-center  fixed w-full right-0 ">
    <div class="absolute grid items-center px-4 top-[35px] duration-700 bg-[#191c24] shadow-2xl drop-shadow-2xl right-0 w-[91.3%] lg:w-[160px] hidden" id="logoutpopup">
        ...
        <div class="flex items-center py-4  border-slate-600">
            <a href="../index.php">
...
<div class="lg:flex lg:items-start bg-[#191c24]">
    ...
    <div class="w-4/5 w-full grid items-center  pt-[75px]">
        <div class="bg-[#000000] grid  items-center px-6 py-3 ">
            <p class="text-white font-semibold">Add Branch</p>
            <div class="grid items-start h-screen xl:grid-cols-2 xl:py-3 xl:gap-6 xl:items-start">
                <div class="grid items-start my-6 px-4 py-4 bg-[#191C24] xl:my-0">
                    <form action="../controller/insert_admin_branch.php" method="post">
                        <div class="grid items-center space-y-3">
                            <p class="text-white font-semibold text-[20px]">Add Branch</p>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Branch Name :-</label>
                                <input type="text" name="branch_name" required placeholder="Branch Name " class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Branch Manager Name :-</label>
                                <input type="text" name="branch_manager_name" required placeholder="Branch Manager Name" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Branch Address :-</label>
                                <input type="text" name="branch_address" required placeholder="Branch Address" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Branch City :-</label>
                                <input type="text" name="branch_city" required placeholder="Branch City" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Mobile No :-</label>
                                <input type="number" name="branch_mobno" required placeholder="Mobile No" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Create Mail :-</label>
                                <input type="email" name="branch_create_email" required placeholder="Create Mail" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Create Password :-</label>
                                <input type="password" name="branch_create_password" required placeholder="Create Password" class="h-[38px] bg-[#2A3038] px-3">
                            </div>
