...
<div class="lg:flex lg:items-start bg-[#191c24]">
    ...
    <div class="w-4/5 w-full grid items-center  pt-[75px]">
        ...
        <div class="bg-[#000000] grid  items-center px-6 py-3 ">
            <p class="text-white font-semibold">Delivery Sheet</p>
            <div class="grid items-start h-screen xl:grid-cols-2 xl:py-3 xl:gap-6 xl:items-start">
                <div class="grid items-start my-6 px-4 py-6 bg-[#191C24] xl:my-0">
                    <form action="../controller/insert_deliverysheet.php" method="post">
                        <div class="grid items-center space-y-3">
                            <p class="text-white font-semibold text-[20px]">Delivery Sheet Details</p>
                            <?php
                            ...
                            <div class="grid items-center text-white space-y-2.5">
                                ...
                                <select name="drs_city" class="h-[38px] bg-[#2A3038] px-3">
                                    <?php foreach ($insert as $data): ?>
                                        <option value="<?= $data['ab_branch_city'] ?>"><?= $data['ab_branch_city'] ?>
                                        </option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="flex items-center text-white space-x-2.5 font-semibold">
                                <div class="">
                                    <a href="../components/deliveryrunsheet.php">
                                        <button class="bg-[#0090e7] h-[30px] w-[75px] text-[15px] rounded-sm">Make
                                            Drs</button>
                                    </a>
                                </div>
                                <div class="">
