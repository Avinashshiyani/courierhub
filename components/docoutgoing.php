...
<div class="lg:flex lg:items-start bg-[#191c24]">
            ...
            <div class="grid items-center h-full bg-[#191c24]  justify-center pr-6 ">
                ...
                <div class="grid items-start py-1">
                    ...
                    <a href="../components/docoutgoing.php" class="flex">
                        <div class="flex items-center w-full space-x-2  py-2 bg-[#0F1015] rounded-r-full px-4">
                            <div class="flex justify-center p-[20px] items-center h-[31px] w-[31px] bg-[rgba(108,114,147,0.2)] rounded-full">
                                <i class=""></i>
    ...
    <div class="w-4/5 w-full grid items-center  pt-[75px]">
        ...
        <div class="bg-[#000000] grid  items-center px-6 py-3 ">
            <p class="text-white font-semibold">Document Incoming</p>
            <div class="grid items-start h-screen xl:grid-cols-2 xl:py-3 xl:gap-6 xl:items-start">
                <div class="grid items-start my-6 px-4 py-6 bg-[#191C24] xl:my-0">
                    <form action="../controller/start_outgoing.php" method="post">
                        <div class="grid items-center space-y-3">
                            <p class="text-white font-semibold text-[20px]">outgoing</p>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Outgoing Date :-</label>
                                <input type="text" name="date" required placeholder="Incoming Date" class="h-[38px] bg-[#2A3038] px-3 innsershowdate">
                            </div>
                            <?php
                            ...
                            ?>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Outgoing From City :-</label>
                                <select name="from_city" class="h-[38px] bg-[#2A3038] px-3">
                            ...
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Outgoing To City:-</label>
                            ...
                            <div class="flex items-center text-white space-x-2.5 font-semibold">
                                <div class="">
                                    <a href="../components/doc_outgoing.php">
                                        <button class="bg-[#0090e7] h-[30px] w-[75px] text-[15px] rounded-sm">Outgoing</button>
                                    </a>
                                </div>
                            </div>
                        </div>
