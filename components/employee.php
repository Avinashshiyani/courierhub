...
<div class=" grid items-center  fixed w-full right-0 ">
    <div class="absolute grid items-center px-4 top-[35px] duration-700 bg-[#191c24] shadow-2xl drop-shadow-2xl right-0 w-[91.3%] lg:w-[160px] hidden"
        id="logoutpopup">
...
<div class="lg:flex lg:items-start bg-[#191c24]">
                ...
                <div class="grid items-start py-1">
                    ...
                    <a href="../Dashboard/branch_dashboard.php" class="flex">
                        <div class="flex items-center w-full space-x-2  py-2 rounded-r-full px-4">
                            <div
                                class="flex justify-center p-[20px] items-center h-[31px] w-[31px] bg-[rgba(108,114,147,0.2)] rounded-full">
    ...
    <div class="w-4/5 w-full grid items-center  pt-[75px]">
        ...
        <div class="bg-[#000000]  grid items-center px-6 py-3 ">
            <p class="text-white font-semibold">Employee</p>

            <div class="grid items-center h-screen xl:grid-cols-2 xl:py-3 xl:gap-6 xl:items-start">
                <form action="../controller/insert_branch_employee.php" method="post">
                    <input type="hidden" name="user_id" value="<?= $_SESSION['branch_user']['ab_id']?>"> 
                    <div class="grid items-center my-6 px-4 py-6 bg-[#191C24] xl:my-0">
                        <div class="grid items-center space-y-3">
                            <p class="text-white font-semibold text-[20px]">Employee Add</p>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Name :-</label>
                                <input type="text" name="employee_name" required placeholder=" Name"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Role :-</label>
                                <input type="text" name="employee_role" required placeholder="Role Of Employee"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="grid items-center text-white space-y-2.5">
                                <label for="">Salary :-</label>
                                <input type="number" name="employee_salary" required placeholder="From Name"
                                    class="h-[38px] bg-[#2A3038] px-3">
                            </div>
                            <div class="flex items-center text-white space-x-2.5 font-semibold">
                                <div class="">
                                    <a href="">
                                        <button
                                            class="bg-[#0090e7] h-[30px] w-[75px] text-[15px] rounded-sm">Add</button>
                                    </a>
                                </div>
                                <div class="">
                                    <a href="">
                                        <button type="submit"
                                            class="bg-[#0D0D0D] h-[30px]  w-[75px] text-[15px] rounded-sm">Cancel</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid items-center  px-6 py-4 bg-[#191C24]">
                    <div class="grid items-center space-y-3">
                        <p class="text-white font-semibold text-[20px]">Total Employees</p>
                        ...
                        <?php include '../controller/select_branch_employee.php'; ?>
                        <?php foreach ($select as $row): ?>
                            <div class="grid items-center space-y-2 py-2.5">
                                <div class="flex  items-center bg-[#2A3038] justify-between ">
                                    <div class="text-white w-full  text-center  ">
                                        <span>
                                            <?= $row['be_id'] ?>
                                        </span>
                                    ...
                                    <div class="flex items-center text-white w-full  text-center ">
                                        ...
                                        <a href="../controller/delete_employee.php?delete=<?= $row['be_id'] ?>"
                                            class="h-[40px] text-red-500 px-2 flex items-center">
                                            <span>Remove</span>
                                        </a>
                                    </div>
                                </div>
