...
<div class="grid px-4 items-start bg-[#000000] h-screen overflow-y-auto">
    <div class="grid items-center ">
        <div class="grid items-start my-6 px-4 py-6 bg-[#191C24] xl:my-4">
            <p class="text-white font-semibold text-[20px]">Total Cash Booking 
            </p>
                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="overflow-hidden">
                        <table class="min-w-full divide-y divide-black-200 ">
                            ...
                            $query = "SELECT * FROM `cash_booking`";
                            ...
                            <tbody class="divide-y divide-black-200 ">
                                <?php foreach ($select as $row) : ?>
                                    <tr class="">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap  text-sm font-medium">
                                            <a href="../components/show_admin_cash.php?delete=<?=$row['cb_id']?>" class="text-red-500 " href="#">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
...
if($_REQUEST){
    ...
    if($delete){
        ...
        echo "<script>window.location.href='../components/show_admin_cash.php'</script>";
    }
}
?>
