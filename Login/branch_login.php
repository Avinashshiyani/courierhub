...
<main class="gradient h-screen w-screen grid justify-center items-center p-4 py-4">
    <div class="flex bg-white rounded-lg space-y-3 bg-red-300  px-4">
        ...
        <form action="../controller/check_branch_login.php" method="post">
            <div class="grid justify-center items-center py-10 md:px-10">
                ...
                <div class="w-full space-y-3">
                    ...
                    <input type="email" name="branch_email" required placeholder="Email"
                        class="w-full  pl-16 h-[50px] bg-[#E6E6E6] rounded-3xl outline-none a focusUser ">
                    <!-- password -->
                    <label for="password" class="absolute pt-[13px] ml-8">
                        <i class="fa-solid fa-lock text-[#666666] passIconStyle"></i>
                    </label>
                    <input type="password" name="branch_password" required placeholder="Password"
                        class="w-full pl-16 h-[50px] bg-[#E6E6E6] rounded-3xl outline-none focusPass ">
                    <label for="passsword">
                ...
                <div class="flex justify-center text-[14px] items-center py-1 pt-28 text-[#666666]">
                    <a href="../index.php">
                        <i
                            class="fa-solid fa-arrow-left rounded-3xl border-2 p-2  px-2.5 hover:text-[#57b846] hover:border-[#57b846]"></i>
                    </a>
                </div>
            </div>
        </form>
